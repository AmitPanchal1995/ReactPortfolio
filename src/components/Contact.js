        ...
        <div name='contact' class='contact' className="w-full h-screen bg-[#0a192f] flex justify-center items-center p-4">
            <form method="POST" action="https://getform.io/f/c7b6c041-0d11-4f72-90c8-9e248d71bfda" className="flex  flex-col max-w-[600px] w-full mt-[10%]">
                <div className="pb-8">
                    ...
                    <p className="text-gray-300 py-2">// Submit form below or shoot me an email- shivanshu91rajput@gmail.com</p>
                </div>
                <input className="bg-[#ccd6f6] bg-gradient-to-l from-blue-500 p-2 rounded" type="text" placeholder="Name" name="name" required />

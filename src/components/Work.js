...
import Tamana from '../assests/TamannaPic.png';


export default function Work() {
    return (
        <div name="work" className="w-full md:h-screen text-gray-300 bg-[#0a192f]">
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full my-[100px]">
                <div className="pb-8">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div
                        style={{ backgroundImage: `url(${Tamana})` }}
